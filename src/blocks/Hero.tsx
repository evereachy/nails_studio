...
/**
 * БЛОК 1 — Первый экран.
 * Задача: за один взгляд объяснить, что это, и дать начать запись без скролла.
...
export function Hero() {
  ...
  return (
    <section id="top" className="relative isolate min-h-[100dvh] overflow-hidden md:min-h-0 md:pt-16">
      {/* Фон-картинка: на мобиле на весь экран, на десктопе — правая колонка */}
      ...
      <Container className="flex min-h-[100dvh] flex-col justify-end pb-4 pt-24 md:min-h-0 md:justify-center md:pb-0">
        <div className="md:grid md:grid-cols-2 md:items-center md:gap-16 md:py-24">
          ...
          {/* Быстрый старт записи — виден на первом экране */}
          <motion.div
